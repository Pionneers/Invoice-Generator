...
class PdfInvoiceApi {
  ...
  static Future<File> generate({
    ...
    required Map<String, Map<String, num>> products,
  }) async {
    final pdf = Document();
    ...
    pdf.addPage(MultiPage(
      build: (context) => [
        ...
        buildTitle(),
        buildInvoice(products, invoiceDate),
        Divider(),
        buildTotal(totalAmount, pendingPayment, paid, isPending),
      ],
  ...
  static Widget buildInvoice(Map<String, dynamic> products, String date) {
    List<Product> list = [];
    final headers = [
      'Description',
      'Date',
...
class Product {
  ...
  double? unitPrice;
  int? amount;
  Product({required this.name, required this.unitPrice, required this.amount});
}